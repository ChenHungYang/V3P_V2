        ...
        while (1)
        {
		    ...
		    szIPASSDTRec[k - 1] == 0x00)
                ...
                if (i > lnIPASSDTLength)
                {
                        if (ginDebug == VS_TRUE)
                        {
                                inDISP_LogPrintf("IPASSDT unpack ERROR.");
                        }
...
int inSaveIPASSDTRec(int inIPASSDTRec)
{
	...
	inTIME_UNIT_InitCalculateRunTimeGlobal_Start(&ulRunTime, "inSaveIPASSDTRec INIT" );
#endif	
	
	inTempIndex = inIPASSDTRec;
	
	memset(szTempFIleName, 0x00, sizeof(szTempFIleName));
	strcat( szTempFIleName, _IPASSDT_FILE_NAME_);
	
	memset(szTempBakFileName, 0x00, sizeof(szTempBakFileName));
	strcat( szTempBakFileName, _IPASSDT_FILE_NAME_BAK_);
	...
	{
		inDISP_DispLogAndWriteFlie("  inSaveHDPTRec *Error* [%d] ", inRetVal);
		inFunc_EDCLock();
		return(VS_ERROR);
	}

	usRetVal = CTOS_FileGetSize((unsigned char *)_IPASSDT_FILE_NAME_, &ulFileSize);	
	
	if(usRetVal != d_OK)
	{
		inDISP_DispLogAndWriteFlie("  inSaveHDPTRec Get FileSize *Error* [%d] Size[%ld]", usRetVal, ulFileSize);
		inFunc_EDCLock();
		/* Close檔案 */
	...
	ulPackCount += strlen(srIPASSDTRec.szIPASS_SAM_Slot);
	uszWriteBuff_Record[ulPackCount] = 0x2C;
	ulPackCount++;

	/* szIPASS_Transaction_Function */
	memcpy(&uszWriteBuff_Record[ulPackCount], &srIPASSDTRec.szIPASS_Transaction_Function[0], strlen(srIPASSDTRec.szIPASS_Transaction_Function));
	ulPackCount += strlen(srIPASSDTRec.szIPASS_Transaction_Function);
	uszWriteBuff_Record[ulPackCount] = 0x2C;
	ulPackCount++;

	/* szIPASS_AMS_TMS_IP_Address */
	memcpy(&uszWriteBuff_Record[ulPackCount], &srIPASSDTRec.szIPASS_AMS_TMS_IP_Address[0], strlen(srIPASSDTRec.szIPASS_AMS_TMS_IP_Address));
	ulPackCount += strlen(srIPASSDTRec.szIPASS_AMS_TMS_IP_Address);
	uszWriteBuff_Record[ulPackCount] = 0x2C;
	ulPackCount++;

	/* szIPASS_BMS_IP_Address */
	memcpy(&uszWriteBuff_Record[ulPackCount], &srIPASSDTRec.szIPASS_BMS_IP_Address[0], strlen(srIPASSDTRec.szIPASS_BMS_IP_Address));
	ulPackCount += strlen(srIPASSDTRec.szIPASS_BMS_IP_Address);
	uszWriteBuff_Record[ulPackCount] = 0x2C;
	ulPackCount++;

	/* szIPASS_System_ID */
	memcpy(&uszWriteBuff_Record[ulPackCount], &srIPASSDTRec.szIPASS_System_ID[0], strlen(srIPASSDTRec.szIPASS_System_ID));
	ulPackCount += strlen(srIPASSDTRec.szIPASS_System_ID);
	uszWriteBuff_Record[ulPackCount] = 0x2C;
	ulPackCount++;

	/* szIPASS_SP_ID */
	memcpy(&uszWriteBuff_Record[ulPackCount], &srIPASSDTRec.szIPASS_SP_ID[0], strlen(srIPASSDTRec.szIPASS_SP_ID));
	ulPackCount += strlen(srIPASSDTRec.szIPASS_SP_ID);
	uszWriteBuff_Record[ulPackCount] = 0x2C;
	ulPackCount++;

	/* szIPASS_Sub_Company_ID */
	memcpy(&uszWriteBuff_Record[ulPackCount], &srIPASSDTRec.szIPASS_Sub_Company_ID[0], strlen(srIPASSDTRec.szIPASS_Sub_Company_ID));
	ulPackCount += strlen(srIPASSDTRec.szIPASS_Sub_Company_ID);
	uszWriteBuff_Record[ulPackCount] = 0x2C;
	ulPackCount++;

	/* szIPASS_Shop_ID */
	memcpy(&uszWriteBuff_Record[ulPackCount], &srIPASSDTRec.szIPASS_Shop_ID[0], strlen(srIPASSDTRec.szIPASS_Shop_ID));
	ulPackCount += strlen(srIPASSDTRec.szIPASS_Shop_ID);
	uszWriteBuff_Record[ulPackCount] = 0x2C;
	ulPackCount++;

	/* szIPASS_POS_ID */
	memcpy(&uszWriteBuff_Record[ulPackCount], &srIPASSDTRec.szIPASS_POS_ID[0], strlen(srIPASSDTRec.szIPASS_POS_ID));
	ulPackCount += strlen(srIPASSDTRec.szIPASS_POS_ID);
...
#ifdef __COUNT_FUNC_TIME__
	inTIME_UNIT_GetRunTimeGlobal(ulRunTime, "inSaveIPASSDTRec END");
#endif
...
int inGetIPASS_SAM_Slot(char* szIPASS_SAM_Slot)
{
        ...
        if (szIPASS_SAM_Slot == NULL || strlen(srIPASSDTRec.szIPASS_SAM_Slot) <= 0 || strlen(srIPASSDTRec.szIPASS_SAM_Slot) > 1)
        {
                ...
                if (ginDebug == VS_TRUE)
                {
                        ...
                        inDISP_LogPrintf("inGetIPASS_SAM_Slot() ERROR !!");

			if (szIPASS_SAM_Slot == NULL)
                        {
                                inDISP_LogPrintf("szIPASS_SAM_Slot == NULL");
                        }
                        else
                        {
                                memset(szErrorMsg, 0x00, sizeof(szErrorMsg));
...
int inSetIPASS_SAM_Slot(char* szIPASS_SAM_Slot)
{
        ...
        if (szIPASS_SAM_Slot == NULL || strlen(szIPASS_SAM_Slot) <= 0 || strlen(szIPASS_SAM_Slot) > 1)
        {
                ...
                if (ginDebug == VS_TRUE)
                {
                        ...
                        inDISP_LogPrintf("inSetIPASS_SAM_Slot() ERROR !!");
                        if (szIPASS_SAM_Slot == NULL)
                        {
                                inDISP_LogPrintf("szIPASS_SAM_Slot == NULL");
                        }
...
int inGetIPASS_Transaction_Function(char* szIPASS_Transaction_Function)
{
        ...
        if (szIPASS_Transaction_Function == NULL || strlen(srIPASSDTRec.szIPASS_Transaction_Function) <= 0 || strlen(srIPASSDTRec.szIPASS_Transaction_Function) > 15)
        {
			...
			if (szIPASS_Transaction_Function == NULL)
                        {
                                inDISP_LogPrintf("szIPASS_Transaction_Function == NULL");
                        }
                        else
                        {
                                memset(szErrorMsg, 0x00, sizeof(szErrorMsg));
...
int inGetIPASS_AMS_TMS_IP_Address(char* szIPASS_AMS_TMS_IP_Address)
{
        ...
        if (szIPASS_AMS_TMS_IP_Address == NULL || strlen(srIPASSDTRec.szIPASS_AMS_TMS_IP_Address) <= 0 || strlen(srIPASSDTRec.szIPASS_AMS_TMS_IP_Address) > 15)
        {
                ...
                if (ginDebug == VS_TRUE)
                {
                        ...
                        inDISP_LogPrintf("inGetAMS_TMS_IP_Address() ERROR !!");

			if (szIPASS_AMS_TMS_IP_Address == NULL)
                        {
                                inDISP_LogPrintf("szIPASS_AMS_TMS_IP_Address == NULL");
                        }
                        else
                        {
                                memset(szErrorMsg, 0x00, sizeof(szErrorMsg));
...
int inSetIPASS_AMS_TMS_IP_Address(char* szIPASS_AMS_TMS_IP_Address)
{
        ...
        if (szIPASS_AMS_TMS_IP_Address == NULL || strlen(szIPASS_AMS_TMS_IP_Address) <= 0 || strlen(szIPASS_AMS_TMS_IP_Address) > 15)
        {
                ...
                if (ginDebug == VS_TRUE)
                {
                        ...
                        inDISP_LogPrintf("inSetAMS_TMS_IP_Address() ERROR !!");
                        if (szIPASS_AMS_TMS_IP_Address == NULL)
                        {
                                inDISP_LogPrintf("szIPASS_AMS_TMS_IP_Address == NULL");
                        }
...
int inGetIPASS_BMS_IP_Address(char* szIPASS_BMS_IP_Address)
{
        ...
        if (szIPASS_BMS_IP_Address == NULL || strlen(srIPASSDTRec.szIPASS_BMS_IP_Address) <= 0 || strlen(srIPASSDTRec.szIPASS_BMS_IP_Address) > 15)
        {
                ...
                if (ginDebug == VS_TRUE)
                {
                        ...
                        inDISP_LogPrintf("inGetBMS_IP_Address() ERROR !!");

			if (szIPASS_BMS_IP_Address == NULL)
                        {
                                inDISP_LogPrintf("szIPASS_BMS_IP_Address == NULL");
                        }
                        else
                        {
                                memset(szErrorMsg, 0x00, sizeof(szErrorMsg));
...
int inSetIPASS_BMS_IP_Address(char* szIPASS_BMS_IP_Address)
{
        ...
        if (szIPASS_BMS_IP_Address == NULL || strlen(szIPASS_BMS_IP_Address) <= 0 || strlen(szIPASS_BMS_IP_Address) > 15)
        {
                ...
                if (ginDebug == VS_TRUE)
                {
                        ...
                        inDISP_LogPrintf("inSetBMS_IP_Address() ERROR !!");
                        if (szIPASS_BMS_IP_Address == NULL)
                        {
                                inDISP_LogPrintf("szIPASS_BMS_IP_Address == NULL");
                        }
...
int inGetIPASS_System_ID(char* szIPASS_System_ID)
{
        ...
        if (szIPASS_System_ID == NULL || strlen(srIPASSDTRec.szIPASS_System_ID) <= 0 || strlen(srIPASSDTRec.szIPASS_System_ID) > 2)
        {
                ...
                if (ginDebug == VS_TRUE)
                {
                        ...
                        inDISP_LogPrintf("inGetSystem_ID() ERROR !!");

			if (szIPASS_System_ID == NULL)
                        {
                                inDISP_LogPrintf("szIPASS_System_ID == NULL");
                        }
                        else
                        {
                                memset(szErrorMsg, 0x00, sizeof(szErrorMsg));
...
int inSetIPASS_System_ID(char* szIPASS_System_ID)
{
        ...
        if (szIPASS_System_ID == NULL || strlen(szIPASS_System_ID) <= 0 || strlen(szIPASS_System_ID) > 2)
        {
                ...
                if (ginDebug == VS_TRUE)
                {
                        ...
                        inDISP_LogPrintf("inSetSystem_ID() ERROR !!");
                        if (szIPASS_System_ID == NULL)
                        {
                                inDISP_LogPrintf("szIPASS_System_ID == NULL");
                        }
...
int inGetIPASS_SP_ID(char* szIPASS_SP_ID)
{
        ...
        if (szIPASS_SP_ID == NULL || strlen(srIPASSDTRec.szIPASS_SP_ID) <= 0 || strlen(srIPASSDTRec.szIPASS_SP_ID) > 2)
        {
			...
			if (szIPASS_SP_ID == NULL)
                        {
                                inDISP_LogPrintf("szIPASS_SP_ID == NULL");
                        }
                        else
                        {
                                memset(szErrorMsg, 0x00, sizeof(szErrorMsg));
...
int inGetIPASS_Sub_Company_ID(char* szIPASS_Sub_Company_ID)
{
        ...
        if (szIPASS_Sub_Company_ID == NULL || strlen(srIPASSDTRec.szIPASS_Sub_Company_ID) <= 0 || strlen(srIPASSDTRec.szIPASS_Sub_Company_ID) > 4)
        {
                ...
                if (ginDebug == VS_TRUE)
                {
                        ...
                        inDISP_LogPrintf("inGetSub_Company_ID() ERROR !!");

			if (szIPASS_Sub_Company_ID == NULL)
                        {
                                inDISP_LogPrintf("szIPASS_Sub_Company_ID == NULL");
                        }
                        else
                        {
                                memset(szErrorMsg, 0x00, sizeof(szErrorMsg));
...
int inSetIPASS_Sub_Company_ID(char* szIPASS_Sub_Company_ID)
{
        ...
        if (szIPASS_Sub_Company_ID == NULL || strlen(szIPASS_Sub_Company_ID) <= 0 || strlen(szIPASS_Sub_Company_ID) > 4)
        {
                ...
                if (ginDebug == VS_TRUE)
                {
                        ...
                        inDISP_LogPrintf("inSetSub_Company_ID() ERROR !!");
                        if (szIPASS_Sub_Company_ID == NULL)
                        {
                                inDISP_LogPrintf("szIPASS_Sub_Company_ID == NULL");
                        }
...
int inGetIPASS_Shop_ID(char* szIPASS_Shop_ID)
{
        ...
        if (szIPASS_Shop_ID == NULL || strlen(srIPASSDTRec.szIPASS_Shop_ID) <= 0 || strlen(srIPASSDTRec.szIPASS_Shop_ID) > 6)
        {
                ...
                if (ginDebug == VS_TRUE)
                {
                        ...
                        inDISP_LogPrintf("inGetShop_ID() ERROR !!");

			if (szIPASS_Shop_ID == NULL)
                        {
                                inDISP_LogPrintf("szIPASS_Shop_ID == NULL");
                        }
                        else
                        {
                                memset(szErrorMsg, 0x00, sizeof(szErrorMsg));
...
int inSetIPASS_Shop_ID(char* szIPASS_Shop_ID)
{
        ...
        if (szIPASS_Shop_ID == NULL || strlen(szIPASS_Shop_ID) <= 0 || strlen(szIPASS_Shop_ID) > 6)
        {
                ...
                if (ginDebug == VS_TRUE)
                {
                        ...
                        inDISP_LogPrintf("inSetShop_ID() ERROR !!");
                        if (szIPASS_Shop_ID == NULL)
                        {
                                inDISP_LogPrintf("szIPASS_Shop_ID == NULL");
                        }
...
int inGetIPASS_POS_ID(char* szIPASS_POS_ID)
{
        ...
        if (szIPASS_POS_ID == NULL || strlen(srIPASSDTRec.szIPASS_POS_ID) <= 0 || strlen(srIPASSDTRec.szIPASS_POS_ID) > 2)
        {
			...
			if (szIPASS_POS_ID == NULL)
                        {
                                inDISP_LogPrintf("szIPASS_POS_ID == NULL");
                        }
                        else
                        {
                                memset(szErrorMsg, 0x00, sizeof(szErrorMsg));
