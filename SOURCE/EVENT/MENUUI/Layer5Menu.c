 ...
 *  inMENU05_NewUiFunction2Menu
 *  in: 回傳值型態
 *  MENU05 : 顯示UI層級
 *  NewUiFunction2Menu : 函式功能名稱  
 */
...
/*
Function        : inMENU05_NewUiFunction2Menu
Date&Time       :2018/5/21 下午 4:04
Describe        :
*/
int inMENU05_NewUiFunction2Menu(EventMenuItem *srEventMenuItem)
{
		...
		if (inPageLoop == _PAGE_LOOP_2_)
		{
			switch (inCount)
			{
				case 1:
					...
					break;
				case 2:
					inRetVal = inMENU_DOWNLOAD_CUP_TEST_KEY(srEventMenuItem);	/* 下載銀聯測試Key */
					inRetVal = VS_ERROR;
				...
				case 3:
					...
					break;
				case 4:
					inRetVal = inMENU_CHECK_FILE(srEventMenuItem);
					inRetVal = VS_ERROR;
					inPageLoop = _PAGE_LOOP_1_;
					break;
				case 5:
